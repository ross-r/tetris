...
// - Clipper lets you update the first element (DisplayStart = 0, DisplayEnd = 1) regardless of it being visible or not.
...
struct ImGuiListClipper
{
    ...
    IMGUI_API bool  Step();            // Call until it returns false. The DisplayStart/DisplayEnd fields will be set and you can update/draw those items.
