...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Tree Nodes"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            // 'node_clicked' is temporary storage of what node we have clicked to update selection at the end
            ...
            if (node_clicked != -1)
            {
                ...
                // (update outside of tree loop to avoid visual inconsistencies during the clicking frame)
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), ImGuiChildFlags_None, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            // to only update visible items. The clipper will automatically measure the height of your first item and then
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        if (ImGui::BeginChild("scrolling", ImVec2(0, 0), ImGuiChildFlags_None, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            else
            {
                ...
                // to skip non-visible lines. Here we instead demonstrate using the clipper to only update lines that are
